...
export const MixAvatarApearance = (props) => {
    ...
    const image_url = `https://avataaars.io/?avatarStyle=${'Circle'}&topType=${topType}&accessoriesType=${accessoriesType}&hatColor=${hatColor}&facialHairType=${facialHairType}&clotheType=${clotheType}&clotheColor=${clotheColor}&eyeType=${eyeType}&eyebrowType=${eyebrowType}&mouthType=${mouthType}&skinColor=${skinColor}`;
